 ...
 */
public class AddTramDialog extends JDialog implements ActionListener{
    ...
    private MyForm form;
    public AddTramDialog(Solver solver, MyForm form){
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        Tram tram =  new Tram(Integer.parseInt(number.getText()), r, Integer.parseInt(price.getText()));
        solver.addTransport(tram);
